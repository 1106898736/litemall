...
@Service
public class LitemallIntroduceService {
    Column[] columns = new Column[]{Column.id, Column.suerid, Column.name, Column.picUrl,Column.brief,
            Column.detail,Column.gallery, Column.type};
    @Resource
    ...
    public List<LitemallIntroduce> querySelective(String name, Integer offset, Integer limit, String sort,
                                                  String order) {
        LitemallIntroduceExample example = new LitemallIntroduceExample();
