...
public class AdminIntroduceService {
    private final Log logger = LogFactory.getLog(AdminIntroduceService.class);

    @Resource
    private LitemallIntroduceMapper introduceMapper;

    @Autowired
    private LitemallIntroduceService introduceService;
    ...
    public Object list(String name,
        ...
        List<LitemallIntroduce> goodsList = introduceService.querySelective( name, page, limit, sort, order);
     ...
     */
    @Transactional
    public int update(LitemallIntroduce introduce) {
